...
# NES Game Genie conversion library

=head1 NAME

Convert::NES::GG - Decode and encode NES Game Genie ocdes
...
Convert::NES::GG provides an object-oriented interface for decoding and
...
package Convert::NES::GG;

use strict;
use warnings;
use Carp;

# Usage: Convert::NES::GG->new("ROM");
=head1 new($filename)
